		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Payments",
									"targetURL": "#comsapbyjuspayments-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbyjuspayments-display": {
								"semanticObject": "comsapbyjuspayments",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.byjus.payments",
									"url": sap.ui.require.toUrl("com/sap/byjus/payments")
								}
							}
						}
					}
